package com.github.teocci.libstream.input.gl.render;
...
import static com.github.teocci.libstream.utils.CameraHelper.getVerticesData;
import static com.github.teocci.libstream.utils.gl.PreviewSizeCalculator.calculateViewPort;
...
public class SimpleCameraRender
{
    ...
    public void drawFrame(int width, int height, boolean keepAspectRatio)
    {
        ...
        calculateViewPort(keepAspectRatio, width, height, streamWidth, streamHeight);
