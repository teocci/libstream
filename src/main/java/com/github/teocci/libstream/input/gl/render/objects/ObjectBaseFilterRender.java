...
import com.github.teocci.libstream.input.gl.Sprite;
import com.github.teocci.libstream.input.gl.TextureLoader;
import com.github.teocci.libstream.input.gl.render.filters.BaseFilterRender;
import com.github.teocci.libstream.utils.gl.GlUtil;
import com.github.teocci.libstream.utils.gl.StreamObjectBase;
...
public abstract class ObjectBaseFilterRender extends BaseFilterRender
{
    //rotation matrix
    ...
    public void setPosition(@TranslateTo int positionTo)
    {
    ...
    {
        sprite.scale(streamObject.getWidth() * 100 / streamWidth, streamObject.getHeight() * 100 / streamHeight);
        squareVertexObject.put(sprite.getTransformedVertices()).position(0);
    }
}
