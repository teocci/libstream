...
{
    private static String TAG = LogHelper.makeLogTag(Camera2Manager.class);
            ...
            cameraDevice.createCaptureSession(listSurfaces, new CameraCaptureSession.StateCallback()
            {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession)
                {
                    ...
                    try {
                        ...
                        LogHelper.i(TAG, "camera configured");
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession cameraCaptureSession)
                {
                    ...
                    LogHelper.e(TAG, "configuration failed");
                }
            }, null);
    ...
    public void openCameraId(Integer cameraId)
    {
        ...
        if (prepared) {
            ...
            LogHelper.e(TAG, "Camera2Manager need be prepared, Camera2Manager not enabled");
        }
    }
    ...
    {
        cameraDevice.close();
        LogHelper.i(TAG, "camera disconnected");
    }
