...
public class YUVUtil
{
    ...
    public static byte[] YV12toYUV420byColor(
            byte[] input,
            int width,
            int height,
    ...
    )
    {
        switch (videoEncodingFormat) {
            ...
            case YUV420PACKEDPLANAR:
                ...
                return NV21toYUV420PackedPlanar(
                        YV12toYUV420PackedSemiPlanar(input, width, height),
                        width,
                        height
                );
            default:
    ...
    /**
     * The color transform, @see http://stackoverflow.com/questions/15739684
     */
    ...
    public static byte[] NV21toYUV420byColor(byte[] input, int width, int height, VideoEncodingFormat format)
    {
        switch (format) {
            case YUV420PLANAR:
